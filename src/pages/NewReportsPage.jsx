...
const NewReportsPage = () => {
  ...
  const handleGenerateReport = () => {
    ...
    doc.text(`Total Sales: LKR ${totalSales}`, 20, 40);
    doc.text(`Total Orders: ${totalOrders}`, 20, 50);
    doc.text(`Average Order Value: LKR ${averageOrderValue}`, 20, 60);
    ...
    salesData.labels.forEach((label, index) => {
      doc.text(`${label}: LKR ${salesData.datasets[0].data[index]}`, 20, yPosition);
      yPosition += 10;
    });
    ...
    <div className="new-reports-page">
      ...
      <header className="new-reports-header">
        <div className="new-reports-header-top">
          <div className="new-reports-logo">
